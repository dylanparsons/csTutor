	...
	<div id="container">
        ...
        <div id="middle">
            <div id="center-column">			
                ...
                <div class="table">
                    <table class="listing form" cellpadding="0" cellspacing="0">
                     <form action='drop.php' method='GET'>
						<tbody><tr>
                            <th class="full" colspan="2">Submit entry to Drop from Schedule</th>
                        </tr>
                        <tr>
				...
				{				
					$delete = "DELETE FROM tutor_schedule WHERE Day ='$_GET[day]' AND Tutor ='$_GET[tutor]' AND Time ='$_GET[timings]'";
